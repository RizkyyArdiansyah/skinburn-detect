...
export default function Edukasi() {
  ...
  return (
    <section id="edukasi" className="py-16 bg-gray-50 mt-4 select-none">
      <div className="container mx-auto px-2">
        <h2 data-aos="fade-up" data-aos-duration="1000" className="text-2xl font-bold text-center mb-2">Edukasi Luka Bakar</h2>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100" className="flex flex-wrap justify-center mb-6 gap-2">
          {Object.keys(tabContent).map((tabKey) => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition cursor-pointer ${activeTab === tabKey
                ? "bg-blue-600 text-white shadow-md"
                : "bg-white border border-amber-500 text-gray-700 hover:bg-gray-100"
                }`}
            >
        ...
        {/* Content Section */}
        <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100" className="bg-white border border-amber-500 rounded-xl shadow-md overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                {tabContent.tingkatanLuka.content.map((item, index) => (
                  <div key={index} className="border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
                    <div className="bg-gray-100 h-auto md:h-40 flex items-center justify-center">
                      <img
                        src={item.image}
                        alt={item.degree}
              ...
              <div className="flex flex-col space-y-8">
                {tabContent.firstAid.steps.map((step, index) => (
                  <div key={index} className="flex flex-col md:flex-row gap-6 items-center">
                    <div className="bg-gray-100 rounded-lg h-48 w-full md:w-[28%] flex items-center justify-center overflow-hidden">
                      <img
                        src={step.image}
                        alt={step.title}
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {tabContent.whenToSeek.conditions.map((item, index) => (
                  <div
                    key={index}
                    className={`p-5 rounded-lg border-l-4 border-r-4 ${item.urgent ? "border-red-500 bg-red-50" : "border-yellow-500 bg-yellow-50"
                      }`}
                  >
            ...
            <div className="p-4">
              ...
              <div className="space-y-6">
                {tabContent.myths.items.map((item, index) => (
                  <div key={index} className="flex flex-row gap-6 border-b border-gray-200 pb-6 last:border-0">
                    <div className="bg-gray-100 rounded-lg h-40 w-full md:w-1/4 flex items-center justify-center overflow-hidden">
                      <img
        ...
        {/* Disclaimer */}
        <div data-aos="fade-left" data-aos-duration="1000" className="mt-10 p-4 bg-gray-100 border-l-4 border-yellow-400 rounded">
